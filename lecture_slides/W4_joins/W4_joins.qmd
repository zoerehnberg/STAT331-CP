---
title: "Data Joins + Transformations + Factors"
format: 
  revealjs:
    theme: default
editor: source
...
![](images/pivot_rain1.png){width=35%}
...
![](images/pivot_rain2.png){width=35%}
</center> 
...
#| echo: false
set.seed(2)
eras_data <- read_excel("data/TS_data.xlsx", sheet = 1) |> 
  slice_sample(n = 25)
```
...
## [Lab 4: Childcare Costs](https://zoerehnberg.github.io/STAT331-S23/lab_assignments/lab4/LA4_avocado.html)
