...
+ This means it uses special symbols and formatting to make pretty documents.
...
**R code block** options are included at the top of each code block, prefaced with a #| (hashpipe).
...
-   The R code written in your *.qmd* file gets run **in order**.
    -   We start from scratch, even if you previously ran some of the code.
