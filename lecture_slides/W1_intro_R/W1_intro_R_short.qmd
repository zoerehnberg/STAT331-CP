...
+ Scripts + Notebooks
+ [PA 1: Find the Mistakes](https://zoerehnberg.github.io/STAT331-S23/practice_activities/PA1_short.html) and [Lab 1: Introduction to Quarto](https://zoerehnberg.github.io/STAT331-S23/lab_assignments/lab1/LA1_intro_quarto.html)
...
# [Setting up an R Project](https://earobinson95.github.io/stat331-calpoly-text/01-introduction.html#rprojects)


## Good practice

- Organize your folders carefully, and name them meaningfully:
  * Good -- `/User/zrehnber/Stat331/lab1/`
  * Bad -- `Desktop/stuff/`
    
- Think of `Stat331` as **one** project and *not* each assignment as a new project. **Do not put projects within projects!**
...
1. Process the executable code chunks with `knitr`.
...
## [PA 1: Find the Mistakes](https://zoerehnberg.github.io/STAT331-S23/practice_activities/PA1_short.html)
