...
+ Make sure you **cite** external sources.
  + E.g., many people used `sapply()` to get the variable data types -- this is fine, but where did you find this solution?
...
+ This is not something that you always need to do, but if you are getting weird errors downstream from a `group_by()` statement, try ungrouping your data!
...
+ `.x` -- a placeholder for the variable names being passed into the function.
