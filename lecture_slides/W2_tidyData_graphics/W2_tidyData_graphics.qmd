...
## Let's Talk About Game Planning
...
**Why**: Dr. Robinson and I will be collecting and saving game plans through your Canvas assignment submissions to use in work related to investigating the efficacy of using game plans as a pedagogical tool in the context of statistical computing education.

**Informed Consent**: Please complete the [informed consent](https://canvas.calpoly.edu/courses/130201/pages/informed-consent-for-participation) for game plans on Canvas by Friday 4/12 at 11:59pm.
...
+ with a bidirectional scale (e.g., + and - values), use a **purple-white-orange** color gradient. Always ransition through white!
