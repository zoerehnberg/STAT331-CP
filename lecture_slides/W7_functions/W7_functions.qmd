...
When we use the *embrace operator*, we also have to use the *walrus operator*.
...
+ Remember: we must use *lambda function notation* when calling our own functions inside `across()`!
...
+ Look for patterns!
    + Do observations with missing values have similar characteristics?
