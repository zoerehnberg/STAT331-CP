...
+ **Group Formation Survey** due **Friday, 5/5 at 11:59pm**
  + Helps me gather information about your preferences and work style to facilitate team formation.
  + Your groupmates do not need to be in the same section, but you might find it useful for in-class work time.
+ Group Contracts
+ Project Proposal
...
## `forcats` [cheatsheet](https://posit.co/wp-content/uploads/2022/10/factors-1.pdf)
...
::: callout-note
Queen Elizabeth and King Charles are "remaining" level that were not recoded.
:::
...
#| echo: true
x |>
  fct_relevel(c("Queen Elizabeth", "King Charles", "pet", "fruit")) |> 
  levels()
```
