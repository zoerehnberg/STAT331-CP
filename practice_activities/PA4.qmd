...
**1. Modify the code below (potentially including the file path) to read the military expenditures data into your work space.**
...
**Note:** When referring to one of the year variable names, you **must** put tick marks (above the tab key) around the name. Starting the name of a variable with a number is not commonly read as a variable name -- e.g., ``` `1988`:`2019` ```.
:::
...
::: callout-warning
Unfortunately, creating this plot requires that every year is included in one column!
:::
