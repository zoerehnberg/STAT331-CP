...
10. Add the location of the penguins (`island`) to your visualization. There may be more than one method to address this, however, one method will more easily address the questions below, so you might want to read that question first!
...
## If you finish early... take everything you know, and use it for evil (+2 Challenge Points)
...
To receive your challenge points, upload the url link to your slide to the Canvas Assignment by **Wednesday, April 12 at 10:00am**. We want to be able to look at them during class!
