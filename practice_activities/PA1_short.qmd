...
Each of the following R chunks will cause one or more errors or do the desired task incorrectly.  Find the mistake and correct it to complete the intended action.
...
*Be careful not to* **overwrite** *more than you intend. If this happens, go back and reread in the code, and then run any subsequent code chunks to start fresh with the top_secret vector.*
