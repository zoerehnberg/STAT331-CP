...
2. If you have already [installed R, RStudio, and Quarto](https://earobinson95.github.io/stat331-calpoly-text/01-introduction.html#checkin3-install), you can download the [practice activity template](https://raw.githubusercontent.com/zoerehnberg/STAT331-S23/main/practice_activities/PA1_short.qmd) here.
  + Make sure to move this from your `Downloads` folder into your `STAT331/practice_activities` folder!
...
```{r}
# just run this code chunk -- there is NO ERROR here!
