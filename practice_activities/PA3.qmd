...
5.  This college is in the state where gooey butter cake, the Chiefs, and the Anheuser-Busch Clydesdales are a thing.

6.  More than 1,000 undergraduates attend this college.

7.  The total amount of money made from tuition per year for this college is **not less** than $50,000,000.

8.  Of the three options remaining at this step, Margaret will attend the college that has the lowest admission rate.
