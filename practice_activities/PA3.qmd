...
[Download starter .qmd file](PA3.qmd)
...
Work with those around you - if something goes wrong, ask a friend or neighbor to take a peek at your code and see if any glaring errors (like *syntax errors*) pop out.
...
1.  This college is located in Region 3.
...
5.  This college is in the state where Yoopers, cherries, and using your hand as a map are a thing.

6.  More than 10,000 undergraduates attend this college.

7.  The in state tuition cost to attend this college is **not less** than $14,000.

8.  Of the two options remaining at this step, Ephelia will attend the college that has the lower admission rate.
