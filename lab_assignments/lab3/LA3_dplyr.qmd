...
**12. Think about coding this up if your group of interest is non-white folks. Create a game plan with your thought process and include an image below. You do not need to provide R code.**

![]()

**13. Write code for people below the age of 20.**

```{r}
# code chunk for Q13
```

**14. Write code for non-white women.**

```{r}
# code chunk for Q14
```

**15. Write code for white men above the age of 30.**
...
**16. Determine which subject you believe is secretly Bieber. Justify your answer.**
