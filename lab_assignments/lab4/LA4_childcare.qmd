...
In this lab we're going look at the median weekly cost of childcare across the country. A detailed description of the data can be found [here](https://github.com/rfordatascience/tidytuesday/blob/master/data/2023/2023-05-09/readme.md).

The data set comes to us from [TidyTuesday](https://github.com/rfordatascience/tidytuesday).
...
**1. Briefly describe the dataset (~ 4 senctences). What information does it contain?**
...
**6. The following plot shows, for all ten regions, the change over time for full-time median price for center-based childcare for infants, toddlers, and preschoolers. Recreate the plot. You do not have to replicate the exact finishing touches - e.g., color, theme - but your plot should have the same content, including the order of the facets and legend, reader-friendly labels, axes breaks, and a loess smoother.**
...
Dr Rehnberg will be reading through these and providing feedback!
